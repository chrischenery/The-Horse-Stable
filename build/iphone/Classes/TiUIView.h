...
/**
 Base class for all TheHorseStable views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TheHorseStable view hierarchy (such as wrapped iOS UIViews) was touched.
