...
//Rare exceptions to indicate a bug in the _thehorsestable code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TheHorseStable proxies.
 */
