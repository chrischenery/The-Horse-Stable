...
// in simulator we redefine to format for TheHorseStable Developer console
...
{\
	NSString * exceptionName = [@"org.thehorsestable." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thehorsestable";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITheHorseStableNativeItemNone = -1, 
	UITheHorseStableNativeItemSpinner = -2,
	UITheHorseStableNativeItemProgressBar = -3,
	
	UITheHorseStableNativeItemSlider = -4,
	UITheHorseStableNativeItemSwitch = -5,
	UITheHorseStableNativeItemMultiButton = -6,
	UITheHorseStableNativeItemSegmented = -7,
	
	UITheHorseStableNativeItemTextView = -8,
	UITheHorseStableNativeItemTextField = -9,
	UITheHorseStableNativeItemSearchBar = -10,
	
	UITheHorseStableNativeItemPicker = -11,
	UITheHorseStableNativeItemDatePicker = -12,
	
	UITheHorseStableNativeItemInfoLight = -13,
	UITheHorseStableNativeItemInfoDark = -14,
	
	UITheHorseStableNativeItemDisclosure = -15,
	
	UITheHorseStableNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TheHorseStable instances of
