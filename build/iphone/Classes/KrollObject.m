...
//@interface TheHorseStableObject : NSObject
//@end

@interface TheHorseStableObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TheHorseStableObject class]])
		{
			for (NSString *key in [[(TheHorseStableObject*)o modules] allKeys])
			{
