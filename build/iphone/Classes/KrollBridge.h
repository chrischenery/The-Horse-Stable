...
@interface TheHorseStableObject : KrollCoverageObject {
#else
@interface TheHorseStableObject : KrollObject {
#endif
@private
...
extern NSString * TheHorseStable$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TheHorseStableObject *_thehorsestable;
    KrollObject* console;
	BOOL shutdown;
